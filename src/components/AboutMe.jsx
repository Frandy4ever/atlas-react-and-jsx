...
export default function AboutMe() {
  ...
  const [favoriteTech, setFavoriteTech] = useState("JavaScript and Python");
  ...
  return (
    <div className="about-me">
      ...
      <p>
        ...
        development! I'm passionate about building with {favoriteTech},
        and I'm looking forward to launching my career as a {careerGoals} upon
